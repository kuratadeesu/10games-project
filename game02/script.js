...
// r はクリック判定の半径です。
const differences = [
  { x: 8.0,  y: 13.0, r: 10.0, name: "鳥の色" },
  { x: 23.5, y: 27.0, r: 12.0, name: "屋根とすべり台" },
  { x: 44.0, y: 34.0, r: 10.0, name: "街灯" },
  { x: 90.0, y: 12.0, r: 10.0, name: "太陽" },
  { x: 84.0, y: 39.0, r: 11.0, name: "噴水" },
  { x: 71.0, y: 70.0, r: 10.0, name: "犬の首輪" },
  { x: 91.0, y: 83.0, r: 11.0, name: "花" }
];
